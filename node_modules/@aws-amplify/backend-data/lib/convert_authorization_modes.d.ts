...
import { AuthResources, ConstructFactoryGetInstanceProps, ReferenceAuthResources, ResourceProvider } from '@aws-amplify/plugin-types';
 ...
 */
export declare const buildConstructFactoryProvidedAuthConfig: (authResourceProvider: ResourceProvider<AuthResources | ReferenceAuthResources> | undefined) => ProvidedAuthConfig | undefined;
/**
