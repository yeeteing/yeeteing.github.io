import { DirectiveDefinitionNode, DirectiveNode, EnumValueDefinitionNode, FieldDefinitionNode, InputValueDefinitionNode, TypeDefinitionNode, TypeExtensionNode, TypeSystemDefinitionNode, TypeSystemExtensionNode } from 'graphql';
...
export declare const makeSeenTransformationKey: (directive: DirectiveNode, type: TypeDefinitionNode | TypeExtensionNode, field?: FieldDefinitionNode | InputValueDefinitionNode | EnumValueDefinitionNode, arg?: InputValueDefinitionNode, index?: number) => string;
export declare const matchDirective: (definition: DirectiveDefinitionNode, directive: DirectiveNode, node: TypeSystemDefinitionNode | TypeSystemExtensionNode) => boolean;
