...
const getOverrideIndexName = (config) => {
    var _a;
    const { associatedRelationalDirective } = getReferencesAssociatedField(config);
    const overrideIndexArgument = (associatedRelationalDirective.arguments || []).find((argument) => argument.name.value === 'overrideIndexName');
    return (_a = overrideIndexArgument === null || overrideIndexArgument === void 0 ? void 0 : overrideIndexArgument.value) === null || _a === void 0 ? void 0 : _a.value;
};
exports.getOverrideIndexName = getOverrideIndexName;
