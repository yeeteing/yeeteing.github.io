...
import { ObjectTypeDefinitionNode, FieldDefinitionNode, DirectiveNode, ObjectTypeExtensionNode } from 'graphql';
import { RelationalPrimaryMapConfig, SearchableConfig } from './definitions';
import { RoleDefinition } from './role-definition';
export declare const collectFieldNames: (object: ObjectTypeDefinitionNode | ObjectTypeExtensionNode) => Array<string>;
