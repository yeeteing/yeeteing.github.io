...
class ResolverManager {
    constructor() {
        ...
        this.generateMutationResolver = (typeName, fieldName, resolverLogicalId, dataSource, requestMappingTemplate, responseMappingTemplate) => new TransformerResolver(typeName, fieldName, resolverLogicalId, { requestMappingTemplate, responseMappingTemplate }, ['init', 'preAuth', 'auth', 'postAuth', 'validate', 'preUpdate'], ['postUpdate', 'finish'], dataSource);
...
class TransformerResolver {
    ...
    `;
            ...
            const partition = aws_cdk_lib_1.Stack.of(context.stackManager.scope).partition;
