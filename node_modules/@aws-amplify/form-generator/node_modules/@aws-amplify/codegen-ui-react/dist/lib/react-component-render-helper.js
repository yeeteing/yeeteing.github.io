...
function buildBindingExpression(prop) {
    ...
    const propertyAccess = typescript_1.factory.createPropertyAccessChain(identifier, typescript_1.factory.createToken(typescript_1.SyntaxKind.QuestionDotToken), prop.bindingProperties.field);
