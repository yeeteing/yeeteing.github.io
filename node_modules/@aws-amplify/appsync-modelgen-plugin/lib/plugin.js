...
exports.plugin = exports.pluginSync = void 0;
...
const pluginSync = (schema, rawDocuments, config) => {
    let visitor;
...
exports.pluginSync = pluginSync;
const plugin = (schema, rawDocuments, config) => {
    return (0, exports.pluginSync)(schema, rawDocuments, config);
};
