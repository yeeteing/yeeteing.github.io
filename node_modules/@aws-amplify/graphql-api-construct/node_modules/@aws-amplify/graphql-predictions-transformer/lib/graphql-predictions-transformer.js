...
function createPredictionsLambda(context, stack) {
    ...
    return context.api.host.addLambdaFunction(graphql_transformer_common_1.PredictionsResourceIDs.lambdaName, `functions/${functionId}.zip`, graphql_transformer_common_1.PredictionsResourceIDs.lambdaHandlerName, path.join(__dirname, '..', 'lib', 'predictionsLambdaFunction.zip'), lambda.Runtime.NODEJS_20_X, [], role, {}, cdk.Duration.seconds(graphql_transformer_common_1.PredictionsResourceIDs.lambdaTimeout), stack);
}
