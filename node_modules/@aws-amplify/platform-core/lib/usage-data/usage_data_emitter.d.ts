...
export declare class DefaultUsageDataEmitter implements UsageDataEmitter {
     ...
     */
    constructor(libraryVersion: string, dependencies?: Array<Dependency> | undefined, sessionUuid?: string, url?: import("url").UrlWithStringQuery, accountIdFetcher?: AccountIdFetcher);
