...
const DisplayContainer: React.FC<DisplayContainerProps> = ({ onPageChange, display, children }) => {
    return (
    <div className="display-page">
      <div className="display-container">
        ...
        <div className="display-navigation">
          <button className="display-nav-btn display-nav-active" disabled>RESUME</button>
          <button className="display-nav-btn" onClick={() => onPageChange('projects')}>PROJECTS</button>
          <button className="display-nav-btn" onClick={() => onPageChange('hobbies')}>HOBBIES</button>
        </div>
        ...
        <div className="display-call-icon">
