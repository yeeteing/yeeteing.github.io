...
exports.getType = exports.getField = exports.fieldsWithSqlDirective = exports.isBuiltInGraphqlNode = exports.isSubscriptionNode = exports.isQueryNode = exports.isMutationNode = exports.isBuiltInGraphqlType = exports.isSubscriptionType = exports.isQueryType = exports.isMutationType = exports.isObjectTypeExtensionNode = exports.isObjectTypeDefinitionNode = void 0;
...
const isObjectTypeExtensionNode = (obj) => obj.kind === graphql_1.Kind.OBJECT_TYPE_EXTENSION;
...
const isMutationNode = (obj) => {
    return ((0, exports.isObjectTypeDefinitionNode)(obj) || (0, exports.isObjectTypeExtensionNode)(obj)) && (0, exports.isMutationType)(obj.name.value);
};
exports.isMutationNode = isMutationNode;
const isQueryNode = (obj) => {
    return ((0, exports.isObjectTypeDefinitionNode)(obj) || (0, exports.isObjectTypeExtensionNode)(obj)) && (0, exports.isQueryType)(obj.name.value);
};
exports.isQueryNode = isQueryNode;
const isSubscriptionNode = (obj) => {
    return ((0, exports.isObjectTypeDefinitionNode)(obj) || (0, exports.isObjectTypeExtensionNode)(obj)) && (0, exports.isSubscriptionType)(obj.name.value);
};
