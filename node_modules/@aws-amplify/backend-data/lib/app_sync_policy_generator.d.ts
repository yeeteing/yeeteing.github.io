 ...
 */
export declare class AppSyncPolicyGenerator {
    private readonly graphqlApi;
    private readonly modelIntrospectionSchemaArn?;
    private readonly stack;
    private readonly policyPrefix;
    private policyCount;
    /**
     * Initialize with the GraphqlAPI that the policies will be scoped to
     */
    constructor(graphqlApi: IGraphqlApi, modelIntrospectionSchemaArn?: string | undefined);
    /**
     ...
     */
    generateGraphqlAccessPolicy(actions: AppSyncApiAction[]): Policy;
}
//# sourceMappingURL=app_sync_policy_generator.d.ts.map