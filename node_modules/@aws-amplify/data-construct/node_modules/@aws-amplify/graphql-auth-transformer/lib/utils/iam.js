...
const createPolicyDocumentForManagedPolicy = (context, resources) => {
    ...
    for (const resource of resources) {
        ...
        if (fieldName !== 'null') {
            policyDocumentResources.push(cdk.Fn.sub('arn:${AWS::Partition}:appsync:${AWS::Region}:${AWS::AccountId}:apis/${apiId}/types/${typeName}/fields/${fieldName}', {
            ...
            policyDocumentResources.push(cdk.Fn.sub('arn:${AWS::Partition}:appsync:${AWS::Region}:${AWS::AccountId}:apis/${apiId}/types/${typeName}/*', {
                apiId: context.api.apiId,
                typeName,
            }).toString());
